...
objects/player_fileManager.o:
	$(CC) $(FLAGS) -c src/GUIPlayer/fileManager.cpp -o objects/player_fileManager.o

objects/player_GUIPlayer.o:
	$(CC) $(FLAGS) -c src/GUIPlayer/GUIPlayer.cpp -o objects/player_GUIPlayer.o

objects/player_intf.o:
	$(CC) $(FLAGS) -c src/GUIPlayer/intf.cpp -o objects/player_intf.o

objects/player_player.o:
	$(CC) $(FLAGS) -c src/GUIPlayer/player.cpp -o objects/player_player.o

objects/config_config.o:
	$(CC) $(FLAGS) -c src/config/config.cpp -o objects/config_config.o
