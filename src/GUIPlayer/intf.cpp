...
// res Interface::draw_topPannel(dem w, dem h) {
...
// res Interface::draw_volume(dem x, dem y, dem w) {
//     // vol     -----0--      77%
//     // <--p1-->        <-p2>
//     //         <---h-->
//     // <-----------w----------->
...
// res Interface::draw_timeline(dem x, dem y, dem w) {
//     //  0:21   -----0--      3:21      <  &  >
//     // <--p1-->        <-p2>     <-p3->
//     //         <---h-->
//     // <-----------w------------------------->
...
// res Interface::calc_vol_tim(dem w, dem h) {
...
// res Interface::calc_top(dem w, dem h) {
...
// res Interface::calc_int_metrics(dem w, dem h) {
